 ...
 * @author Acer
 */
public class labMultimedia extends barangLab implements Peminjam{
    public labMultimedia(String namaPeminjam, String barang, String tempat, Long banyak, String kondisi) {
        super(namaPeminjam, barang, tempat, banyak, kondisi);
    }
    
    @Override
    public void barangLabIn(String barang) {
        System.out.println(barang + "merupakan barang Laboratorium Multimedia.");
    }

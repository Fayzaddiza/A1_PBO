...
public class barangLab {
    ...
    void barang1() {
        System.out.println("Ini merupakan data seluruh peminjaman barang Laboratorium Informatika ");
    }

    void barang2() {
        System.out.println("Barang wajib dikembalikan seperti keadaan semula.");
    }
    
    //overloading
    public void barangLabIn(String barang) {
        System.out.println(barang + "merupakan barang Laboratorium Informatika.");
    }
